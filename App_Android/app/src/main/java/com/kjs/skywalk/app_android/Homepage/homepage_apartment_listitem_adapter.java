...
public class homepage_apartment_listitem_adapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (mList != null && mList.size() > 0) {
            ...
            commonFun.displayImageByURL(mContext, houseDigest1.CoverImageUrlS, holder.ivApartment1_thumb, commonFun.IMAGE_TYPE_PROPERTY);
            ...
            if (mList.size() == 1) {
                ...
                commonFun.displayImageByURL(mContext, houseDigest2.CoverImageUrlS, holder.ivApartment2_thumb, commonFun.IMAGE_TYPE_PROPERTY);
